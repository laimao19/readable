...
CREATE TABLE "DiagnosticResult" (
    ...
    "comprehensionScore" REAL NOT NULL,
    "speedScore" REAL NOT NULL,
    "completedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "DiagnosticResult_clerkUserId_fkey" FOREIGN KEY ("clerkUserId") REFERENCES "UserStats" ("clerkUserId") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
INSERT INTO "new_UserStats" ("clerkUserId", "correctAnswers", "createdAt", "dailyGoal", "id", "lastActivity", "lastSessionDuration", "progress", "readingLevel", "startDate", "streak", "totalExercisesCompleted", "totalPassagesRead", "totalQuestions", "totalReadingTime", "updatedAt") SELECT "clerkUserId", "correctAnswers", "createdAt", "dailyGoal", "id", "lastActivity", "lastSessionDuration", "progress", "readingLevel", "startDate", "streak", "totalExercisesCompleted", "totalPassagesRead", "totalQuestions", "totalReadingTime", "updatedAt" FROM "UserStats";
